...
bool ChatHandler::HandleReloadAllLocalesCommand(char* /*args*/)
{
	...
	HandleReloadMailTemplateCommand((char*)"a");
    return true;
}
...
bool ChatHandler::HandleReloadAreaTriggerDevelopCommand(char*)
{
...
bool ChatHandler::HandleReloadMailTemplateCommand(char* /*args*/)
{
